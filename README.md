...
| Kafka, Zookeeper, Alibaba nacos & other technology stack, WebSocket, Netty | Delta Lake, Apache Flink, Apache Hudi, Apache Iceberg, kettle, canal, Flink-CDC, Debezium, Prometheus+Grafana |
