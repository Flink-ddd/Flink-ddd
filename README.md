...
| rocketMQ, pulsar, Kafka, Zookeeper, Alibaba nacos/dubbo/Canal/other technology stack, WebSocket, Netty | Delta Lake, Apache Flink, Apache Hudi, Apache Iceberg, kettle, Flink-CDC, Debezium, Prometheus+Grafana |
