...
| :--- | :--- |
| Java, Spring Boot, Spring Cloud, Mybatis-Plus | Python, PyTorch, Transformers, DeepSpeed, vLLM, ray |
...
3.  **vLLM & Transformers & DeepSpeed & Triton & Ray & flashinfer & pytorch Contribution (Ongoing)**
